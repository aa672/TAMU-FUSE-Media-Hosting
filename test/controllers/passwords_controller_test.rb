...
class PasswordsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create password" do
    assert_difference('Password.count') do
      post passwords_url, params: { password: { password: @password.password, password_id: @password.password_id, password_name: @password.password_name } }
    end
  ...
  test "should update password" do
    patch password_url(@password), params: { password: { password: @password.password, password_id: @password.password_id, password_name: @password.password_name } }
